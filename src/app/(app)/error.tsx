...
/**
 * Error boundary pour les pages app (simulateur, carte, comparateur, etc.)
 * Intégré dans le layout app avec Navbar/Footer.
 */
export default function AppError({
  ...
  useEffect(() => {
    console.error('[AQUIZ App Error]', error)
  }, [error])
    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-20">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-aquiz-gray text-sm mb-6 leading-relaxed">
          Un problème est survenu sur cette page. Vos simulations sauvegardées ne sont pas affectées.
        </p>
