...
export const alt = 'AQUIZ Simulateur — Calculez votre capacité d\'achat immobilier'
    ...
    (
      ...
      >
        ...
        <div style={{ fontSize: 22, color: 'rgba(255, 255, 255, 0.4)', fontWeight: 400, marginBottom: 40, display: 'flex' }}>
          Calculez votre capacité d&apos;achat en 2 minutes
        </div>

        {/* Features */}
        <div style={{ display: 'flex', gap: 32, alignItems: 'center' }}>
          {['Capacité d\'emprunt', 'Faisabilité', 'Score bancaire'].map((text, i) => (
        ...
        <div style={{ position: 'absolute', bottom: 40, display: 'flex', fontSize: 16, color: 'rgba(255, 255, 255, 0.25)' }}>
          www.aquiz.eu/simulateur · 100% gratuit
        </div>
      </div>
    ),
    { ...size },
