...
export const alt = 'AQUIZ Mode B — Puis-je acheter ce bien ? Vérifiez la faisabilité de votre projet'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Decorative circle */}
        <div style={{ position: 'absolute', top: 80, right: 120, width: 200, height: 200, borderRadius: '50%', background: 'rgba(34, 197, 94, 0.06)' }} />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24, padding: '8px 20px', borderRadius: 40, background: 'rgba(34, 197, 94, 0.1)', border: '1px solid rgba(34, 197, 94, 0.2)' }}>
          <div style={{ fontSize: 20, fontWeight: 800, color: '#22c55e', display: 'flex' }}>B</div>
          <div style={{ fontSize: 18, color: '#22c55e', fontWeight: 600, display: 'flex' }}>Mode Faisabilité</div>
        </div>
        ...
        <div style={{ fontSize: 22, color: 'rgba(255, 255, 255, 0.4)', fontWeight: 400, marginBottom: 40, display: 'flex' }}>
          Vérifiez la faisabilité de votre projet immobilier
        </div>

        {/* Features */}
        <div style={{ display: 'flex', gap: 32, alignItems: 'center' }}>
          {['Faisabilité', 'Score bancaire', 'Reste à vivre'].map((text, i) => (
        ...
        <div style={{ position: 'absolute', bottom: 40, display: 'flex', fontSize: 16, color: 'rgba(255, 255, 255, 0.25)' }}>
          www.aquiz.eu/simulateur/mode-b · 100% gratuit
        </div>
      </div>
    ),
    { ...size },
